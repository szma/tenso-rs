...
impl Context {
    ...
    fn tensor(&self, data: &[f32], shape: &[usize]) -> Tensor<'_> {
...
impl<'a> Tensor<'a> {
    ...
    fn set_data(&self, data: ArrayD<f32>) {
...
fn matmul<'a>(a: Tensor<'a>, b: Tensor<'a>) -> Tensor<'a> {
    let result_data = {
